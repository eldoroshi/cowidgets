...
class Posts_Carousel extends Widget_Base {
	...
	public function get_title() {
		return __( 'Posts Carousel', 'cowidgets' );
	}
	/**
	...
	public function get_script_depends() {
		return [ 'ce-posts-carousel', 'tiny-slider' ];
    }
	...
	protected function register_controls() {
		$this->register_posts_carousel_controls();
	}
	/**
	 ...
	 * @access protected
	 */
	protected function register_posts_carousel_controls() {
		\COWIDGETS_Helpers::postsSelectionSection( $this );
		...
		$this->add_control(
			...
			[
				...
				'options' => apply_filters( 'ce_load_element_styles', [
					'adair'	=> __( 'Adair', 'cowidgets' ),
					'colm'	=> __( 'Colm', 'cowidgets' ),
					'birk'	=> __( 'Birk', 'cowidgets' ),
					'rowan'	=> __( 'Rowan', 'cowidgets' ),
					'box'	=> __( 'Box', 'cowidgets' ),
					'vernon' => __( 'Vernon', 'cowidgets' )
				] ),
			]
        );
		...
		$this->add_control(
			...
			[
				...
				'render_type' => 'template',
				'selectors' => [
					'{{WRAPPER}} .ce-posts-carousel article' => 'height: {{SIZE}}{{UNIT}}',
					'{{WRAPPER}} .ce-posts-carousel article .post-thumbnail' => 'height: {{SIZE}}{{UNIT}}',
				],
				'condition' => [
					'item_style' => 'rowan'
				]
        ...
        $this->add_control(
			...
			[
                ...
                'selectors' => [
                    '{{WRAPPER}} .ce-posts-carousel .tns-item' => 'vertical-align: {{VALUE}}',
                ],
	...
	protected function render() {
        ...
        $this->add_render_attribute( 'ce-posts-carousel', 'class', [ 'ce-posts-carousel', 'ce-post-style-' . $settings['item_style'] ] );
		$this->add_render_attribute( 'ce-posts-carousel', 'data-columns', $settings['columns'] );
        $this->add_render_attribute( 'ce-posts-carousel', 'data-autoplay', $settings['autoplay'] );
        $this->add_render_attribute( 'ce-posts-carousel', 'data-slide-by', ( $settings['slide_by'] == 'page' ? $settings['columns'] : $settings['slide_by'] ) );
        $this->add_render_attribute( 'ce-posts-carousel', 'data-loop', $settings['loop'] );
        $this->add_render_attribute( 'ce-posts-carousel', 'data-gutter', $settings['gutter']['size'] );
        $this->add_render_attribute( 'ce-posts-carousel', 'data-center', $settings['center'] );
		$this->add_render_attribute( 'ce-posts-carousel', 'data-mouse-drag', $settings['mouse_drag'] );
		$this->add_render_attribute( 'ce-posts-carousel', 'data-edge-padding-side', $settings['edge_padding_side'] );
		$this->add_render_attribute( 'ce-posts-carousel', 'data-carousel-controls', $settings['carousel_controls'] );
        ...
        if( isset( $settings['edge_padding'] ) && !empty( $settings['edge_padding'] ) )
            $this->add_render_attribute( 'ce-posts-carousel', 'data-edge-padding', $settings['edge_padding']['size'] );

        if( isset( $settings['start_index'] ) && !empty( $settings['start_index'] ) )
            $this->add_render_attribute( 'ce-posts-carousel', 'data-start-index', $settings['start_index'] );
		...
		<?php } ?>
		<div <?php echo wp_kses_post( $this->get_render_attribute_string( 'ce-posts-carousel' ) ); ?>>
