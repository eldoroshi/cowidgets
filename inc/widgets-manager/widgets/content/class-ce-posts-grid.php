...
class Posts_Grid extends Widget_Base {
	...
	public function get_title() {
		return __( 'Posts Grid', 'cowidgets' );
	}
	/**
	...
	protected function register_posts_grid_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'default'     => [],
				'selectors'   => [
					'{{WRAPPER}} .ce-posts-grid .ce-post-item' => 'padding: {{SIZE}}{{UNIT}}',
					'{{WRAPPER}} .ce-posts-grid' => 'margin-left: -{{SIZE}}{{UNIT}}; margin-right: -{{SIZE}}{{UNIT}}'
				],
				'render_type' => 'template'
			]
		);
	...
	protected function render() {
        ...
        $this->add_render_attribute( 'ce-posts-grid', 'class', [ 'ce-posts-grid', 'ce-post-style-' . $settings['item_style'] ] );
		$this->add_render_attribute( 'ce-posts-grid', 'data-columns', $settings['columns'] );
		$this->add_render_attribute( 'ce-posts-grid', 'data-layout', $settings['layout'] );
		...
		?>
		<div <?php echo wp_kses_post( $this->get_render_attribute_string( 'ce-posts-grid' ) ); ?>>
