        	...
        	<div class="entry-wrapper-content">
                ...
                <div class="entry-content">
                    ...
                    <h5 class="portfolio-title">
                        ...
                        <a href="<?php echo esc_url( COWIDGETS_Helpers::portfolioItemPermalink( $settings ) ) ?>" class="cl-portfolio-title" title="<?php echo esc_attr( COWIDGETS_Helpers::portfolioItemTitle( $settings ) ) ?>"><?php echo wp_kses_post( COWIDGETS_Helpers::portfolioItemTitle( $settings ) ) ?></a>
