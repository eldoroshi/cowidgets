...
class Copyright extends Widget_Base {
	...
	public function get_icon() {
		return 'ce-icon-copyright-widget';
	}
	/**
	...
	protected function register_content_copy_right_controls() {
		...
		$this->add_control(
			'shortcode',
			[
				'label'   => __( 'Copyright Text', 'cowidgets' ),
				'type'    => Controls_Manager::TEXTAREA,
				'dynamic' => [
					'active' => true,
				],
				'default' => __( 'Copyright © [ce_current_year] [ce_site_title] | Powered by [ce_site_title]', 'cowidgets' ),
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ce-copyright-wrapper' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .ce-copyright-wrapper a, {{WRAPPER}} .ce-copyright-wrapper' => 'color: {{VALUE}};',
				],
			]
		);
	...
	protected function render() {
		...
		<div class="ce-copyright-wrapper">
			<?php if ( ! empty( $link ) ) { ?>
				<a href="<?php echo esc_url( $link ); ?>" <?php echo wp_kses_post($this->get_render_attribute_string( 'link' )); ?>>
